...
<template>
  <div w0 h0 bg-red relative preserve-3d class="box" :style="{'transform': `translateX(${box.boxSize * pos.x + box.boxSize / 2}px) translateZ(${box.boxSize / 2}px) translateY(${box.boxSize * pos.y + box.boxSize / 2}px)`}">
